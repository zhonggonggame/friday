...
public class PermissionServiceImpl implements PermissionService {
    ...
    @Override
    public Results<SysPermission> getNavigation(Integer startPosition,Integer limit) {
        return Results.success(permissionDao.findNavigationCount().intValue(),permissionDao.findNavigation(startPosition,limit));
    }

    @Override
    public Results<SysPermission> getGnd(Integer page,Integer limit) {
        return  Results.success(permissionDao.findMenuCount(),permissionDao.findMenu( page,limit));
    }
