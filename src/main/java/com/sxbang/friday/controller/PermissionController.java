...
public class PermissionController {
    ...
    @GetMapping("/menuAll")
    @ResponseBody
    @ApiOperation(value = "获取所有功能点", notes = "获取获取所有功能点所有菜单")//描述
    ...
    @ResponseBody
    @ApiOperation(value = "获取所有功能点", notes = "获取获取所有功能点所有菜单")//描述
    public Results getMenuAll(PageTableRequest request){
        request.countOffset();
        return permissionService.getGnd(request.getOffset(),request.getLimit());
    }
    ...
    @ResponseBody
    @ApiOperation(value = "获取所有菜单", notes = "获取所有菜单")//描述
    public Results getNavigation(PageTableRequest request){
        request.countOffset();
        return permissionService.getNavigation(request.getOffset(),request.getLimit());
    }
